...
\only<presentation>{
	...
	\titlepage	
	%		\makebox[0pt][l]{%
	%		\raisebox{-185pt}[1cm][-30cm]{%
	%\vspace{-0.5cm}
	\includegraphics[width=\textwidth]{\PathToMedia/cover.jpg}
 \vfill
{\scriptsize\itshape This work is licensed under a  \hyperref{http://creativecommons.org/licenses/by-sa/4.0/}{}{}{\color{cyan}Creative Commons ``Attribution-ShareAlike 4.0 International''} License.}
}%}
\end{frame}
